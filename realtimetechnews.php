<?php
/*
Plugin Name:Realtime tech news
Plugin URI: http://zvoid.com/blog1/
Description: get the latest technological news in realtime .
Author: Akram Artoul
Version: 1.2
...
if($_POST['tit']){
add_option('outtit', 'Realtime tech news', '', 'no');
...
function widget_realtimetechnews($args) {
...
//echo $optionsArray["background"];
	...
	$params="&bc=".$optionsArray["background"]."&bxc=".$optionsArray["boxback"]."&tcolor=".$optionsArray["color"]."&zc=".$optionsArray["zc"]."&zbc=".$optionsArray["zbc"]."&n=".$optionsArray["n"];
	

?>
	<div>

	<iframe src="http://zvoid.com/wi/index.php?ct=tech&lang=english<?php echo($params); ?>" id="streamnewslive" style="width:<?php echo($optionsArray["width"]); ?>;height:<?php echo($optionsArray["height"]); ?>;" frameborder="no" scrolling="no" width="<?php echo($optionsArray["width"]); ?>" height="<?php echo($optionsArray["height"]); ?>"></iframe>
...
function widget_realtimetechnews_control() {
global $optionsArray;
...
function widget_realtimetechnews_init() {
	global $optionsArray, $prefix;
	foreach($optionsArray AS $ok=>$ov) {
	...
	register_sidebar_widget("Realtime tech news", "widget_realtimetechnews");
	register_widget_control("Realtime tech news", "widget_realtimetechnews_control");
}

add_action("plugins_loaded", "widget_realtimetechnews_init");
